      ...
      <main className="main" id="content">
        ...
        <section>
          <nav id="navbar" className="main-nav navbar fixed-top">
            ...
            <div
              className={isActive ? "sidebar" : "closed-sidebar"}
              id="NavItems"
            >
                      ...
                      <div className="row bio-main">
                        ...
                        <div className="col-lg-6 col-sm-12 center-center mbl-d-none tblt-d-none">
                          <Fade triggerOnce="true" direction="right">
                            ...
                            {/* <lottie-player
                              src="https://assets2.lottiefiles.com/packages/lf20_edzccurz.json"
                        ...
                        <Fade triggerOnce="true" direction="right">
                          <div className="roadmap-content-right">
                            ...
                            <div className="roadmap-context">
                              ...
                              from raiders. In our hub there will be special
                              nft's for warrior holders and supporters.
                            </div>
                          </div>
                        </Fade>
                      </div>
                        ...
                        <Fade triggerOnce="true" direction="left">
                          <div className="roadmap-content-left q4">
                            ...
                            <div className="roadmap-context">
                              ...
                              Galacticore. We will be launching our new P2E IDLE
                              Game. The game will get updates regularly to keep
                              the players and the game itself alive.
                            </div>
                          </div>
                        </Fade>
                      </div>
                      ...
                      <div className="col-lg-6 col-sm-12">
                        <Fade triggerOnce="true" direction="right">
                          <div className="roadmap-content-right">
                            ...
                            <div className="roadmap-context">
                              We will be launching our very first governance
                              token to expand, share and discuss our vision with
                              others.
                            </div>
                          </div>
                        </Fade>
                    ...
                    <div className="col-lg-8">
                      <div className="accordion">
                        ...
                        <div className="accordion-item" id="question5">
                          ...
                          <div className="answer">
                            <p>
                              Galacticore is a mining (Idle) based play and
                              earn. In this game you'll be able to mine around
                              the universe. You will get items by mining rewards
                              and fight with other players from other planets.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-6 footer-right">
                      <ul className="footer-social-link">
                        ...
                        <li className="footer-link" id="campfire">
                          <a
                            href="https://campfire.exchange/collections/0x0c65c0c4aade84fcbf9ec4354902ee576e24e8dc?sortType=price&sortDirection=asc&onlyForSale=false"
                            target="_blank"
                            rel="noreferrer"
